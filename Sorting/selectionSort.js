...
function selectionSort(numbers = []) {
    // Iterate over the array from 0 to the second to last index
    for (let i = 0; i < numbers.length - 1; i++) {
        let smallest = i;
        // Then j starts at the index next to i and always skips i index
        for (let j = i + 1; j < numbers.length; j++) {
            // If a smaller value is found we udate the varaibale to the new index which is j
